...
namespace MingweiSamuel.TokenBucket
{
    /// <inheritdoc />
    /// <summary>
    ...
    /// </code>
    /// </summary>
    public class CircularTokenBucket : ITokenBucket
    {
        ...
        /// </param>
        public CircularTokenBucket(TimeSpan timeSpan, int totalLimit, int temporalFactor, float spreadFactor, float totalLimitFactor)
        ...
        public CircularTokenBucket(TimeSpan timeSpan, int totalLimit, int temporalFactor, float spreadFactor,
